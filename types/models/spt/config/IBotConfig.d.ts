...
export interface IPresetBatch {
    ...
    followerBoar: number;
    followerBoarClose1: number;
    followerBoarClose2: number;
    ...
    followerTest: number;
    followerZryachiy: number;
    gifter: number;
    infectedAssault: number;
    infectedCivil: number;
    infectedLaborant: number;
    infectedPmc: number;
    infectedTagilla: number;
    marksman: number;
    peacefullZryachiyEvent: number;
    peacemaker: number;
    pmcBEAR: number;
    pmcBot: number;
    pmcUSEC: number;
    ravangeZryachiyEvent: number;
    sectactPriestEvent: number;
    sectantOni: number;
    sectantPredvestnik: number;
    sectantPriest: number;
    sectantPrizrak: number;
